...
export default function Pipeline() {
	...
	return (
		<section ref={containerRef} id="pipeline" className="relative w-full min-h-screen lg:h-[120vh] bg-onyx overflow-hidden flex items-center justify-center border-t border-white/10" style={{ perspective: "1500px" }}>
			...
			<div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-12 h-full flex flex-col md:flex-row items-center justify-between pointer-events-none py-24 md:py-0">
				
				{/* Left Side Content */}
				<div className="flex-1 flex flex-col justify-center text-left w-full h-full pt-[12vh] md:pt-0">
					<div className="overflow-hidden p-2">
						<h2 className="text-left-slam font-anton text-[13vw] md:text-[8vw] lg:text-[12rem] uppercase leading-[0.9] tracking-wider m-0 text-white drop-shadow-2xl">
							NOT JUST
						</h2>
					</div>
					<div className="overflow-hidden p-2">
						<h2 className="text-left-slam font-anton text-[13vw] md:text-[8vw] lg:text-[12rem] uppercase leading-[0.9] tracking-wider m-0 text-white/50 drop-shadow-2xl">
							A LOGO
						</h2>
					</div>
				</div>
				...
				<div className="flex-1 flex flex-col justify-end md:justify-center items-start md:items-end text-right w-full h-full pb-[10vh] md:pb-0 z-20">
					<div className="text-right-slam border-l-4 md:border-l-0 md:border-r-4 border-crimson-red pl-5 md:pl-0 md:pr-8 max-w-lg bg-onyx/60 backdrop-blur-md p-5 md:p-6 pointer-events-auto shadow-2xl text-left md:text-right">
						<span className="font-inter font-bold text-[#406eb5] tracking-[0.2em] uppercase text-xs md:text-sm flex mb-3 md:mb-4 items-center md:justify-end gap-3">
							Strategic Acquisition <span className="w-8 h-[2px] bg-[#406eb5] inline-block"></span>
						</span>
						<p className="font-inter text-sm md:text-base lg:text-2xl text-white/90 leading-relaxed font-light drop-shadow-md">
